...
(function (NotifSystem) {
    ...
    })(Administration = NotifSystem.Administration || (NotifSystem.Administration = {}));
...
(function (NotifSystem) {
    ...
    })(BasicSamples = NotifSystem.BasicSamples || (NotifSystem.BasicSamples = {}));
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = NotifSystem.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = NotifSystem.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = NotifSystem.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (NotifSystem) {
    ...
    })(Common = NotifSystem.Common || (NotifSystem.Common = {}));
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
    var Common;
...
(function (NotifSystem) {
    ...
    })(Membership = NotifSystem.Membership || (NotifSystem.Membership = {}));
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
    var Membership;
...
(function (NotifSystem) {
    ...
    })(Northwind = NotifSystem.Northwind || (NotifSystem.Northwind = {}));
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
    var Northwind;
...
(function (NotifSystem) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'NotifSystem.Northwind.Gender', 'NotifSystem.Northwind.Entities.Gender');
    })(Northwind = NotifSystem.Northwind || (NotifSystem.Northwind = {}));
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
...
(function (NotifSystem) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'NotifSystem.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = NotifSystem.Northwind || (NotifSystem.Northwind = {}));
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
...
(function (NotifSystem) {
    ...
    })(Authorization = NotifSystem.Authorization || (NotifSystem.Authorization = {}));
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
    var Administration;
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        }(NotifSystem.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(NotifSystem.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(NotifSystem.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        }(NotifSystem.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        NotifSystem.Common.ReportHelper.execute({
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: NotifSystem.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: NotifSystem.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new NotifSystem.Northwind.OrderDialog();
                        ...
                        var chai = NotifSystem.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = NotifSystem.Northwind.EmployeeRow.getLookup().items
        ...
        }(NotifSystem.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(NotifSystem.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        }(NotifSystem.Northwind.OrderDialog));
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    NotifSystem.Northwind.CategoryService.Retrieve({
        ...
        }(NotifSystem.Northwind.CategoryDialog));
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        }(NotifSystem.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(NotifSystem.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new NotifSystem.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                NotifSystem.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(NotifSystem.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    NotifSystem.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(NotifSystem.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(NotifSystem.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    NotifSystem.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return NotifSystem.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return NotifSystem.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return NotifSystem.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return NotifSystem.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return NotifSystem.LanguageList.getValue();
            };
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        }(NotifSystem.Northwind.SupplierDialog));
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(NotifSystem.Northwind.SupplierGrid));
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return NotifSystem.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return NotifSystem.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return NotifSystem.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return NotifSystem.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return NotifSystem.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                NotifSystem.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    NotifSystem.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(NotifSystem.Northwind.CustomerDialog));
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        }(NotifSystem.Northwind.CustomerGrid));
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = NotifSystem.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return NotifSystem.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(NotifSystem.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return NotifSystem.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new NotifSystem.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(NotifSystem.Northwind.OrderDetailDialog));
...
(function (NotifSystem) {
    ...
    (function (Northwind) {
        ...
        }(NotifSystem.Common.GridEditorBase));
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        }(NotifSystem.Northwind.OrderDetailsEditor));
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return NotifSystem.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return NotifSystem.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return NotifSystem.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return NotifSystem.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return NotifSystem.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new NotifSystem.BasicProgressDialog();
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        ...
        }(NotifSystem.Common.BulkServiceAction));
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return NotifSystem.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return NotifSystem.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return NotifSystem.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return NotifSystem.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(NotifSystem.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new NotifSystem.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new NotifSystem.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new NotifSystem.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (NotifSystem) {
    ...
    NotifSystem.SelectableEntityGrid = SelectableEntityGrid;
})(NotifSystem || (NotifSystem = {}));
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return NotifSystem.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return NotifSystem.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return NotifSystem.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return NotifSystem.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(NotifSystem.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = NotifSystem.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            NotifSystem.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return NotifSystem.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return NotifSystem.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return NotifSystem.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return NotifSystem.Northwind.ProductService.baseUrl; };
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return NotifSystem.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return NotifSystem.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return NotifSystem.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return NotifSystem.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return NotifSystem.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return NotifSystem.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (NotifSystem) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return NotifSystem.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return NotifSystem.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return NotifSystem.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (NotifSystem) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = NotifSystem.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = NotifSystem.LanguageList || (NotifSystem.LanguageList = {}));
})(NotifSystem || (NotifSystem = {}));
...
(function (NotifSystem) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('NotifSystem');
        Serenity.EntityDialog.defaultLanguageList = NotifSystem.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = NotifSystem.ScriptInitialization || (NotifSystem.ScriptInitialization = {}));
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
    ...
    NotifSystem.BasicProgressDialog = BasicProgressDialog;
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
    var DialogUtils;
    ...
    })(DialogUtils = NotifSystem.DialogUtils || (NotifSystem.DialogUtils = {}));
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
    var Common;
...
(function (NotifSystem) {
    ...
    NotifSystem.StaticTextBlock = StaticTextBlock;
})(NotifSystem || (NotifSystem = {}));
var NotifSystem;
(function (NotifSystem) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: NotifSystem.Authorization.userDefinition.DisplayName,
...
//# sourceMappingURL=NotifSystem.Web.js.map