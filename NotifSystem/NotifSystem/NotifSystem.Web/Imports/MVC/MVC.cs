...
namespace MVC
{
    public static class Views
    {
        ...
        {
            public static class DemoNotification
            {
                public const string DemoNotificationIndex = "~/Modules/Default/DemoNotification/DemoNotificationIndex.cshtml";
            }

            public static class Notification
            {
                public const string NotificationIndex = "~/Modules/Default/Notification/NotificationIndex.cshtml";
            }

            public static class SimpleChat
            {
                public const string SimpleChatIndex = "~/Modules/Default/SimpleChat/SimpleChatIndex.cshtml";
            }
        }
